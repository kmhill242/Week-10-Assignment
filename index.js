...
row.insertCell(0).innerHTML = document.getElementById('new-task').ariaValueMax;
row.insertCell(1).innerHTML = `${createdDate.getFullYear()}-${createdDate.getMonth() + 1}-${createDate.getDate()}`;
